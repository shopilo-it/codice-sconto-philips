...
Sursa: https://shopilo.it/negozi/philips.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/philips.it"
STORE_NAME = "Philips"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Philips da shopilo.it"""
    headers = {
